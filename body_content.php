...
<section class="home-content">
   <div class="container home-block">
      <div class="row">
         <div class="col-lg-8">
            <div class="inner-block">
               ...
               <div class="home-overview borders-line">
                  ...
                  <div class="overview-case">
                     <h6>Casino Features</h6>
                     <span> Blackjack, Casicshot,Jackpot Games,Live Casino, Pay'n Play, Roullette, Table Game,Video Pocker
                     Video Slots, VIP Programs
                     </span>
                  </div>
                  <div class="overview-case">
                     <h6>Estabilished</h6>
                  ...
                  <div class="overview-case">
                     <h6>Withdrawal Limits</h6>
                     <span> €10000 per month</span>
                  </div>
                  <div class="overview-case">
                     <h6>Bonus</h6>
                     <span> 100% up to €300 + 100 free spins</span>
                  </div>
               </div>
               <div class="inner-block">
                  ...
                  <div class="home-overview borders-line">
                     ...
                     <div class="overview-case">
                        <h6>First Deposit Free Spins</h6>
                        <span> 300
                        </span>
                     </div>
                     <div class="overview-case">
               ...
               <div class="inner-block">
                  ...
                  <div class="home-overview borders-line">
                     ...
                     <div class="overview-case">
                        ...
                        <span> Blackjack, Casicshot,Jackpot Games,Live Casino, Pay'n Play, Roullette, Table Game
                        </span>
                     </div>
                  </div>
               </div>
         ...
         <div class="col-lg-4 inner-block right-sidebar">
            <h4> Table Of Content</h4>
            <ul>
               <li>Lorem Ipsum est simplement </li>
               <li>Lorem Ipsum est simplement est simplement </li>
               <li>Lorem Ipsum est simplement </li>
               <li>Lorem Ipsum est simplement </li>
               <li>Lorem Ipsum est simplement est simplement </li>
               <li>Lorem Ipsum est simplement </li>
   ...
   <div class="mid-inner container">
      <div class="inner-block col-lg-8">
         <h1>Normal Context Text</h1>
         <div class="">
      ...
      <div class="inner-block-text col-lg-8">
    <div class="inner-block-head">   <span class="num-round"> 1</span> <h2>  Normal Context Text</h2></div> 
         <div class="">
            <div class="overview-p">
               <p>
                  Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie
            ...
            <div class="inner-block-text col-lg-8">
    <div class="inner-block-head">   <span class="num-round"> 2</span> <h2>  Normal Context Text</h2></div> 
         <div class="">
            <div class="overview-p">
               <p>
                  Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie
            ...
            <div class="inner-block-text col-lg-8">
    <div class="inner-block-head">   <span class="num-round">3</span> <h2>  Normal Context Text</h2></div> 
         <div class="">
            <div class="overview-p">
               <p>
                  Le Lorem Ipsum est simplement du faux texte employé dans la composition et la mise en page avant impression. Le Lorem Ipsum est le faux texte standard de l'imprimerie
